...
@class SentryDsn;
@class SentryLog;
SWIFT_ENUM_FWD_DECL(NSInteger, SentryLastRunStatus)
@class SentryScope;
...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryANRType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryFeedbackSource)
...
@class SentrySpanId;
SWIFT_ENUM_FWD_DECL(NSInteger, SentryLogLevel)
...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryProfileLifecycle)
...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryReplayType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryReplayQuality)
